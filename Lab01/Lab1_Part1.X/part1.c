...
int main(void)
{
    ...
    /*
        valsToBeSorted[0]: 198	198	198	42	42	42
        valsToBeSorted[1]: 210	210	210	198	78	78
        valsToBeSorted[2]: 42	42	42	210	198	198
        valsToBeSorted[3]: 78	78	78	78	210	210
        valsToBeSorted[4]: 176 	176	176	176	176	176
     */
    int i, j;
    for (i = 0; i < 5; i++) {
